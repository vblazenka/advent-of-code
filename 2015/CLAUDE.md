...
Advent of Code 2015 solutions in Python 3.13, managed with uv. The repository uses a dual testing system: pytest for proper unit tests and legacy inline tests via main.py CLI.
